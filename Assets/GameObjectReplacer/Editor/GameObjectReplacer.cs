...
namespace GOReplacer
{
	public class GameObjectReplacer : EditorWindow 
	{
		...
		private static bool CopyRotation, CopyScale, CopyOrderInLayer;
		...
		private void Replace()
		{
			...
			foreach(GameObject gameObject in GameObjects)
			{
                ...
                if (CopyOrderInLayer)
                    newGameObject.GetComponent<SpriteRenderer>().sortingOrder = gameObject.GetComponent<SpriteRenderer>().sortingOrder;
		...
		private void GetLayoutFields(bool isSceneView = false)
		{
            ...
            CopyOrderInLayer = EditorGUILayout.Toggle("Copy OrderInLayer", CopyOrderInLayer);
